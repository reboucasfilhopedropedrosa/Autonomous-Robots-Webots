...
#
# Simulação 08 com drone Mavic 2 Pro - Webots R2023a
# Decolagem e manter-se na altitude de 1m, exibindo a imagem
# da câmera
...
class Mavic (Robot):
    ...
    def __init__(self):
        ...
        self.camera_pitch_motor.setPosition(0.1)
    ...
    def run(self):
        ...
        while self.step(self.time_step) != -1:
            ...
            Camera.getImage(self.camera)
            Camera.saveImage(self.camera, 'color.png', 1)

            frame_color = cv2.imread('color.png')
